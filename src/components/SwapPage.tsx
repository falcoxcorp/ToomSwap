...
const SwapPage: React.FC<SwapPageProps> = ({ onNavigateHome }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      {/* Header with CONTROLLED Z-INDEX */}
      <motion.header
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="relative swap-page-header flex items-center justify-between p-4 sm:p-6"
        style={{ zIndex: 10 }}
      >
      ...
      {/* Main Content with CONTROLLED Z-INDEX */}
      <main className="relative swap-page-main container mx-auto px-4 sm:px-6 pb-8 sm:pb-12 flex-1" style={{ zIndex: 5 }}>
